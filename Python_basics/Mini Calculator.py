...
print("\nAddition of both the integers", "is:",a + b) #'\n' is an escape sequence which help in running the code from the next like (one-line gap)
print("Subtraction of both the integers", "is:",a - b)
print("Multiplication of both the integers", "is:",a * b)
